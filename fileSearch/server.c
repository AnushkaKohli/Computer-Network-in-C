...
int main()
{
    ...
    for (;;)
    {
        ...
        while (1)
        {
            ...
            {
                rbuff[r] = '\0';
                printf("SERVER: File name sent by client to search is: %s\n", rbuff);
            ...
            {
                rbuff[r] = '\0';
                printf("SERVER: File name sent by client to open is: %s\n", rbuff);
                ...
                if ((s = sendto(skfd, "end", 128, 0, (struct sockaddr *)&cli_addr, cli_addr_len)) < 0)
                {
                    ...
                    printf("\nSERVER: Result of the opening of file sent to client %s.\n", inet_ntoa(cli_addr.sin_addr)); /*sent 's' bytes to client*/
            }
        }
    }
    return 0;
